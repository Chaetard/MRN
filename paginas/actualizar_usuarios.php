...
$idUser = $_POST["txt_usuario_oculto"];
$nombre = strtoupper(trim($_POST["nombre_usuario"]));
$Contras = $_POST["contra"];
$Tipo = $_POST["tipoU"];


$sqlUPDATE = "UPDATE usuarios SET usuario = '$nombre', clave = '$Contras',
   tipousuario = '$Tipo' WHERE id_usuario='$idUser'";
    ...
    <div id="contenedorPrincipal" class="container-fluid ">
        ...
        <div class="tablas msjc">
            ...
            <div>
                ...
                <br />
                <br />
                <a href="alta_usuarios.php">REGISTRAR OTRO USUARIO</a>
            </div>
            <!-- Termina Aqui -->
        </div>
