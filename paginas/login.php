    ...
    <div class="logContainer animate__animated animate__fadeInDown">
        <form action="./validacion.php" method="post" onsubmit="return ValidaFormulario()">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" placeholder="Ingresa el usuario" name="txtusuario"
                    id="txtusuario" required>
            </div>

            <div class="mb-3">
                <label for="txtpassword" class="form-label">Contraseña</label>
                <input type="password" class="form-control" placeholder="Ingresa la contraseña" name="txtpassword"
